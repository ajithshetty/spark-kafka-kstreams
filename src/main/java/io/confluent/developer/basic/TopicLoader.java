    ...
    public static void main(String[] args) throws IOException {
     ...
     public static void runProducer() throws IOException {
        ...
        try(Admin adminClient = Admin.create(properties);
            ...
            //List<NewTopic> topics = Arrays.asList(outputTopic+","+outputTopic.split(",").);
            ...
            List <String> rawRecords = Arrays.asList("orderNumber-1001",
                                               "orderNumber-5000",
                                               "orderNumber-999",
                                               "orderNumber-3330",
                                               "bogus-1",
                                               "bogus-2",
                                               "orderNumber-8400");
            List<ProducerRecord<String, String>> producerRecords = rawRecords.stream()
                    .map(r -> new ProducerRecord<>(inputTopic,"order-key", r)).collect(Collectors.toList());
